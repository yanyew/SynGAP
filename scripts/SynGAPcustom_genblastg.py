...
def SynGAPcustom(sp1, sp2, annoType1, annoKey1, annoparentKey1, annoType2, annoKey2, annoparentKey2,
    ...
    custom_anchors = workDir + '/' + str(sp1) + '.' + str(sp2) + '.anchors'
    os.chdir(workDir)
    ...
    custom_anchors_rename = SynGAP_workspace_Dir + '/' + str(sp1) + '.' + str(sp2) + '.renamed.anchors'
    ...
    os.system('mkdir ' + SynGAP_workspace_Dir + '/original_id')
    os.system('mkdir ' + SynGAP_workspace_Dir + '/renamed_id')
    ...
    print('[\033[0;36mINFO\033[0m] Running Done!\n')
    print('[\033[0;36mINFO\033[0m] Renaming the gene ids in custom anchors files, please wait ...')
    anchors_rename.rename_anchors(custom_anchors, sp1mRNAmap, sp2mRNAmap, custom_anchors_rename)
    print('[\033[0;36mINFO\033[0m] Running Done!\n')
    ...
    gapfind.gap_find(sp1bed_rename, sp2bed_rename, custom_anchors_rename, anchors_rename_gap)
    print('[\033[0;36mINFO\033[0m] Running Done!\n')
    ...
    print('[\033[0;36mINFO\033[0m] Naming the renamed geneids back to original geneids in '
          '`\033[0;35m.anchors.gap\033[0m`, please wait ...')
    anchors_originalid = SynGAP_workspace_Dir + '/' + str(sp1) + '.' + str(
        sp2) + '.anchors'
    anchors_gap_originalid = SynGAP_workspace_Dir + '/' + str(sp1) + '.' + str(
        sp2) + '.anchors.gap'
    nameback.nameback(anchors_rename_gap, sp1mRNAmap, sp2mRNAmap, anchors_gap_originalid)
    print('[\033[0;36mINFO\033[0m] Running Done!\n')
    os.system('ln -s ' + custom_anchors + ' ' + anchors_originalid)
    Sgenepairs_originalid = SynGAP_workspace_Dir + '/' + str(sp1) + '.' + str(sp2) + '.originalid.anchors.genepairs'
    print('[\033[0;36mINFO\033[0m] Extracting syntenic gene pairs from custom anchors for '
          '\033[0;35m' + str(sp1) + '\033[0m and \033[0;35m' + str(sp2) + '\033[0m , please wait ...')
    getgenepairs.get_genepair(custom_anchors, Sgenepairs_originalid)
    print('[\033[0;36mINFO\033[0m] Running Done!\n')
    os.system('ln -s ' + custom_anchors + ' ' + SynGAP_results_Dir + '/' + str(sp1) + '.' + str(
        sp2) + '.anchors')
    ...
    os.system('mkdir ' + SynGAP_workspace_Dir + '/gapanno')
    ...
    os.symlink(str(script_dir) + '/bin/genBlast_v138_linux_x86_64/formatdb', 'formatdb')
    os.symlink(str(script_dir) + '/bin/genBlast_v138_linux_x86_64/blastall', 'blastall')
    os.symlink(str(script_dir) + '/bin/genBlast_v138_linux_x86_64/alignscore.txt', 'alignscore.txt')
    ...
    os.system('mkdir ' + SynGAP_workspace_Dir + '/filter')
    os.system(
    ...
    os.system('mkdir ' + SynGAP_workspace_Dir + '/Rlabel')
    ...
    print('[\033[0;36mINFO\033[0m] Performing CPC to predict coding posibility for '
          'original genome annotations, please wait ...')
    os.system('mkdir ' + SynGAP_workspace_Dir + '/CPC')
    ...
    os.system('mkdir ' + SynGAP_workspace_Dir + '/function')
    ...
    os.system('mkdir ' + SynGAP_workspace_Dir + '/cluster')
    ...
    os.system('mkdir ' + jcviafterSynGAP_Dir)
